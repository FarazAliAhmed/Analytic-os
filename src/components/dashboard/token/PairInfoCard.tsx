...
const PairInfoCard: React.FC = () => (
    <div className="bg-[#151517] rounded-lg p-4 text-gray-200">
        ...
        <div className="mb-2 flex justify-between"><span>Pooled BWAH</span><span>56,832,948 <span className="text-xs text-gray-400">₦126.4m</span></span></div>
        <div className="mb-2 flex justify-between"><span>Pooled SOL</span><span>552.22 <span className="text-xs text-gray-400">₦126.4m</span></span></div>
