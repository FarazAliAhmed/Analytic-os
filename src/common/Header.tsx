        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-4">
            ...
            {tokenSymbol && tokenPrice && (
              <div className="flex flex-col items-start">
                <div className="text-3xl font-bold text-[#C8FF00]">
                  ₦{tokenPrice.toLocaleString('en-NG', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                </div>
            ...
            {tokenSymbol && (
              ...
              >
                <svg className="w-6 h-6" fill={isInWatchlist ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
